...
#     爬虫伪装，防止对方防火墙、安全设备发现
#     代理ip、随机user agent
#     需同时打开settings.py 中的 DOWNLOADER_MIDDLEWARES
#     """
#     def process_request(self,request,spider):
#         # 设置代理服务器的地址和端口号
#         # 此处使用的阿布云 https://www.abuyun.com/http-proxy/products.html
#         request.meta['proxy'] = 'http-cla.abuyun.com:9030'
#         # 账号密码
#         procy_name_pass = b'H211EATS905745KC:F8FFBC929EB7D5A7'
#         # base64加密
#         encode_pass_name = base64.b64encode(procy_name_pass)
